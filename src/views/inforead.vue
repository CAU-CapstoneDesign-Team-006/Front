...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            axios
                .post('http://ec2-13-125-55-59.ap-northeast-2.compute.amazonaws.com:3000/infocommunication/read', params)
                .then(res => {
            ...
            axios
                .post('http://ec2-13-125-55-59.ap-northeast-2.compute.amazonaws.com:3000/infocommunication/getbest', params)
                .then(res => {
        ...
        methods : {
            update() {
                ...
                if (this.gmail === temp_gmail)
                {
                    ...
                    axios
                        .post('http://ec2-13-125-55-59.ap-northeast-2.compute.amazonaws.com:3000/infocommunication/update', params)
                        .then(res => {
                            alert('수정 페이지로 이동합니다.');
            ...
            del() {
                ...
                if (this.gmail === temp_gmail) 
                {
                    ...
                    if (sure === "삭제")
                    {
                        ...
                        params.append('no', this.no);
                        axios
                            .post('http://ec2-13-125-55-59.ap-northeast-2.compute.amazonaws.com:3000/infocommunication/delete', params)
                            .then(res => {
            ...
            updown() {
                ...
                if (this.state === false) {
                    axios
                        .post('http://ec2-13-125-55-59.ap-northeast-2.compute.amazonaws.com:3000/infocommunication/pushbest', params)
                        .then(res => {
                            console.log('f')
                    ...
                    axios
                        .post('http://ec2-13-125-55-59.ap-northeast-2.compute.amazonaws.com:3000/infocommunication/deletebest', params)
                        .then(res => {
                            console.log('t')
                            console.log(res.data)
                            if (res.data === 'done') {
